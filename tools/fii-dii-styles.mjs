...
export function fiiDiiStyles() {
  return `<style>
  .mf{--mf-up:var(--up);--up-fill:#3c8f6c;--up-bg:rgba(79,174,131,.12);--dn:var(--down);--dn-fill:#b85c68;--dn-bg:rgba(215,120,132,.12);--flat:var(--flat);--mf-accent:var(--accent);display:grid;gap:26px;margin-bottom:30px}
  .mf > *{min-width:0}
  .mf .pos{color:var(--mf-up)}.mf .neg{color:var(--dn)}.mf .flat{color:var(--flat)}
  ...
  .mf-card::after{content:"";position:absolute;inset:0 0 auto 0;height:2px;background:linear-gradient(90deg,var(--mf-accent),transparent)}
  ...
  .mf-regime.bullish{background:var(--up-bg);color:var(--mf-up);border:1px solid rgba(79,174,131,0.2)}
  ...
  .mf-ann{display:inline-block;font-size:9px;font-weight:900;padding:1px 5px;border-radius:3px;background:var(--mf-accent);color:#04121b;margin-left:4px;vertical-align:middle;text-transform:uppercase;letter-spacing:.05em}
  ...
  #mf-stk:checked~.mf-tabs label[for=mf-stk]{background:var(--mf-accent);border-color:var(--mf-accent);color:#04121b}
  ...
  .mf-table tfoot td{font-weight:850;border-top:1px solid var(--mf-accent);border-bottom:none;color:#e2e8f0}
  ...
  .mf-sub a.on{background:rgba(70,173,196,.14);border-color:var(--mf-accent);color:#cffafe}
  ...
  .mf-read h3::before{content:"";width:8px;height:8px;border-radius:50%;background:var(--mf-accent);box-shadow:0 0 10px var(--mf-accent)}
  ...
  .mf-read li::before{content:"▹";position:absolute;left:0;color:var(--mf-accent)}
  ...
  @media (max-width:600px){
    ...
    .mf-table tfoot tr {background:var(--panel);border:1px solid var(--mf-accent)}
