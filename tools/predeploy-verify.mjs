...
function verifyVercelArtifacts() {
  ...
  assertOutput("multibagger/index.html", /Baseline live|Rs 5L public baseline/);
  ...
  assertOutput("multibagger/index.html", /Entries captured 04 May 2026, 02:12 pm/);
  assertOutput("multibagger/index.html", /Share this tracker/);
