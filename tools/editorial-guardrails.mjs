...
export const PUBLIC_FORBIDDEN_PATTERNS = [
  /^\bThe source flags\b/i,
  /^\btreat it as a watchlist cue\b/i,
  /^(Negative Macro Impact|Global Risk-Off Cue|Volatile Opening Bias|Hook|Global Cue|India Read|Market Driver|Opening Bias|Sector Watch)$/i,
  /generated by a language model/i,
