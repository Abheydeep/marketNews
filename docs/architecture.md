...
- [marketnarrative-admin](https://github.com/Abheydeep/marketnarrative-admin) - Vite + React 19 SPA for admin workflows.
- [marketnarrative-trade](https://github.com/Abheydeep/marketnarrative-trade) - Next.js 15 dashboard for the trading cockpit UI.
